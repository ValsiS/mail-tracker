...
``` bash
$ composer require valsis/mail-tracker ~2.1
```
...
``` php
valsis\MailTracker\MailTrackerServiceProvider::class,
```

Publish the config file and migration
``` bash
$ php artisan vendor:publish --provider="valsis\MailTracker\MailTrackerServiceProvider"
```
...
When an email is sent, viewed, or a link is clicked, its tracking information is counted in the database using the valsis\MailTracker\Model\SentEmail model. You may want to do additional processing on these events, so an event is fired in these cases:

* valsis\MailTracker\Events\EmailSentEvent
* valsis\MailTracker\Events\ViewEmailEvent
* valsis\MailTracker\Events\LinkClickedEvent
...
* valsis\MailTracker\Events\PermanentBouncedMessageEvent
...
use valsis\MailTracker\Events\ViewEmailEvent;
...
use valsis\MailTracker\Events\PermanentBouncedMessageEvent;
...
* valsis\MailTracker\Exceptions\BadUrlLink - the base64 decode of the URL parameter failed to return a valid redirect link. This may happen if somehow the URL gets truncated or is forged.
...
[ico-version]: https://img.shields.io/packagist/v/valsis/mail-tracker.svg?style=flat-square
[ico-license]: https://img.shields.io/badge/license-MIT-brightgreen.svg?style=flat-square
[ico-travis]: https://img.shields.io/travis/valsis/MailTracker/master.svg?style=flat-square
[ico-scrutinizer]: https://img.shields.io/scrutinizer/coverage/g/valsis/MailTracker.svg?style=flat-square
[ico-code-quality]: https://img.shields.io/scrutinizer/g/valsis/MailTracker.svg?style=flat-square
[ico-downloads]: https://img.shields.io/packagist/dt/valsis/mail-tracker.svg?style=flat-square

[link-packagist]: https://packagist.org/packages/valsis/mail-tracker
[link-travis]: https://travis-ci.org/valsis/MailTracker
[link-scrutinizer]: https://scrutinizer-ci.com/g/valsis/MailTracker/code-structure
[link-code-quality]: https://scrutinizer-ci.com/g/valsis/MailTracker
[link-downloads]: https://packagist.org/packages/valsis/mail-tracker
[link-author]: https://github.com/valsis
