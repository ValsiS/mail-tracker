...
use valsis\MailTracker\Events\EmailSentEvent;
use valsis\MailTracker\Model\SentEmailUrlClicked;
...
class MailTracker implements \Swift_Events_SendListener
{
    ...
    protected function updateSesMessageId($message)
    {
        ...
        $hash = ($headers->get('X-Mailer-Hash')) ? $headers->get('X-Mailer-Hash')->getFieldBody() : null;
